...
Public Class Form1
    ...
    Sub copy()
        Try
            ...
            '===== URL yang dituju untuk request =====
            Dim request As HttpWebRequest = DirectCast(WebRequest.Create("http://localhost:8080/copy/copy.php"), HttpWebRequest)

            '===== Method Reques =====
            request.Method = "POST"

            Dim tujuan = "upload/" & OpenFileDialog1.SafeFileName.ToString()

            '===== Data POST dan konversikan ke array byte =====
            Dim PostData As String = "lokasi=" + TextBox8.Text & "&tujuan=" + tujuan
            Dim byteArraypostData() As Byte = Encoding.UTF8.GetBytes(PostData)
    ...
    Sub copy_simpan()
        Try
            ...
            '===== URL yang dituju untuk request =====
            Dim request As HttpWebRequest = DirectCast(WebRequest.Create("http://localhost:8080/copy/insert.php"), HttpWebRequest)
            ...
            '===== Data POST dan konversikan ke array byte =====
            Dim PostData As String = "tujuan=" + tujuan
            Dim byteArraypostData() As Byte = Encoding.UTF8.GetBytes(PostData)
    ...
    Sub copy_baca()
        ...
        Try
            ...
            '===== URL yang dituju untuk request =====
            Dim situs As String = "http://localhost:8080/copy/anggota.json"
            Dim request As HttpWebRequest = DirectCast(WebRequest.Create(situs), HttpWebRequest)
            ...
            Using dataStream As Stream = response.GetResponseStream()
                ...
                Dim picture As String = objek.SelectToken("[3].alamat")

                'menampilkan kedalam Propertis
